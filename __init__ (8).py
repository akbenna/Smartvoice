...
ai-consultassistent/
├── services/
│   ├── audio-capture/       # Audio-opname API (FastAPI)
│   ├── transcription/       # Whisper STT + diarisatie
│   ├── extraction/          # LLM medische extractie
│   ├── soep-generator/      # SOEP-concept generatie
│   ├── detection/           # Rode vlaggen + missing info
│   ├── export/              # HIS-export service
│   └── audit/               # Logging en audit trail
├── frontend/
...
- Audit trail op alle patiëntdata-toegang
